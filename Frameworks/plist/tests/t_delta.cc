...
void test_delta ()
{
	...
	plist::dictionary_t const oldPlist   = std::get<plist::dictionary_t>(plist::parse_ascii(oldPlistString));
	plist::dictionary_t const newPlist   = std::get<plist::dictionary_t>(plist::parse_ascii(newPlistString));
	plist::dictionary_t const deltaPlist = std::get<plist::dictionary_t>(plist::parse_ascii(deltaPlistString));
