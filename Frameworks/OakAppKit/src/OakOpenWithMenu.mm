...
- (void)openDocumentURLs:(NSArray<NSURL*>*)documentURLs withApplicationURL:(NSURL*)applicationURL
{
	...
	[NSWorkspace.sharedWorkspace openURLs:documentURLs withApplicationAtURL:applicationURL configuration:NSWorkspaceOpenConfiguration.configuration completionHandler:^(NSRunningApplication* app, NSError* error){
		if(error)
